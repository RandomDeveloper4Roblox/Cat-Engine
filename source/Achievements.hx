...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["How the fuck did you do this?", "Beat Week 8 on Hard with no Misses.",			'week8_nomiss',			 false],
		["Poppy FunkTime.",             "Beat Week 9 on Hard with no Misses.",			    'week9_nomiss',			 false],
	...
	public static function unlockAchievement(name:String):Void {
		...
		FlxG.sound.play(Paths.sound('achievemntSound'), 0.7);
