...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Purrfect!!', 1.2] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	var mama:FlxTypedGroup<BunzoMamaBG>;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			// 
			case 'musicStage': //Week 9
			    var music:BGSprite = new BGSprite('fondomusic',-200, 0, .35, .35);
				music.setGraphicSize(Std.int(1.1 * music.width));
				music.updateHitbox();
				add(music);
			
				mama = new FlxTypedGroup<BunzoMamaBG>();
				add(mama);

				var theStagemusic:BGSprite = new BGSprite('stagemusic', -1200, -1100);
				theStagemusic.setGraphicSize(Std.int(1.15 * theStagemusic.width));
				theStagemusic.updateHitbox();
				add(theStagemusic);
				...
				var theShadow2:BGSprite = new BGSprite('shadow2', -1200, -1700);
				theShadow2.setGraphicSize(Std.int(1.15 * theShadow2.width));
				theShadow2.updateHitbox();
				add(theShadow2);

				var theTube:BGSprite = new BGSprite('tube', 60, -1500);
				theTube.setGraphicSize(Std.int(1.15 * theTube.width));
				theTube.updateHitbox();
				add(theTube);

				var thePlataform:BGSprite = new BGSprite('plataform', -500, 650);
				thePlataform.setGraphicSize(Std.int(1.15 * thePlataform.width));
				thePlataform.updateHitbox();
				add(thePlataform);

				var pads:BGSprite = new BGSprite('pads', -350, 650);
				pads.setGraphicSize(Std.int(1.15 * pads.width));
				pads.updateHitbox();
				add(pads);

				var theShadow:BGSprite = new BGSprite('shadow', -1200, -1700);
				theShadow.setGraphicSize(Std.int(1.15 * theShadow.width));
				theShadow.updateHitbox();
				add(theShadow);

				var theScreenshadow:BGSprite = new BGSprite('screenshadow',-1200, -900);
				theScreenshadow.setGraphicSize(Std.int(1.15 * theShadow.width));
				theScreenshadow.updateHitbox();
				add(theScreenshadow);

				// text

			    var sky:BGSprite = new BGSprite('negro', -1100, -1000, 0, 0);
				add(sky);
		}
